...
FuncParam   : BType IDENT                                               { $$ = New_node("FuncParam", 2, $1, $2); }  
            | BType IDENT "[" "]"                                       { $$ = New_node("FuncParam", 2, $1, $2); $$->add_child(new Node("INTCONST", "0"));}
            | BType IDENT "[" "]" Widths                                { $$ = New_node("FuncParam", 2, $1, $2); $$->add_child(new Node("INTCONST", "0")); $$->get_value($5); }
